...
/**
 The base class for all KitchenSink modules
 */
...
/**
 KitchenSink Platform calls this method on startup.
 */
-(void)startup;

/**
 KitchenSink Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 KitchenSink Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 KitchenSink Platform calls this method on resume.
 @param sender The sender of the event.
 */
